...
admin=['ue92d89cc346863c640b8a7855e14abd7',clMID]
msg_dict = {}
bl = [""]
        ...
        if op.type == 26 or op.type == 25:
            ...
            if sender in admin:
                if msg.text in ["คำสั่ง"]:
                    ...
                    cl.sendMessage(to, "ผู้เขียนบอท:")
                    cl.sendContact(to, "ue92d89cc346863c640b8a7855e14abd7")
